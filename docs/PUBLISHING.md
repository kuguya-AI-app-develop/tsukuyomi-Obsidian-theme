...
更新日期：2026-09-21。用户已授权完成公开发布、提交审核并跟进至通过。当前版本为 **1.2.0**，GitHub 已公开发布，官方复核已完成；1.0.0 保留为首个正式版本。电影场景扩展研究继续暂停。

## 主题发布与 irop.one 同步（2026-09-21）

网站已同步 1.2.0，并增加真实 CSS 动效的浏览器演示；实施与实测范围见[联动验收记录](homepage-sync-2026-09-21.md)。
